...
export default function SignInChaseScreen() {
  ...
  return (
    <>
      ...
      <AuthLayout>
        <Text style={styles.title}>Sign in to Chase</Text>
        <Text style={styles.body}>Your credentials go directly to Chase — we never see your password</Text>
        ...
        <View style={styles.field}>
          <TextInput placeholder="Chase username" placeholderTextColor="#8A8A99" value={username} onChangeText={setUsername} style={styles.input} />
        </View>
        ...
        <Text style={styles.note}>Chase may send you a verification code to confirm your identity.</Text>

        <View style={styles.bottomZone}>
          <Text style={styles.disclaimer}>
            By continuing, you authorize read-only access to your Chase account data per Plaid's end-user privacy policy. Credit Clear cannot move or transfer your funds.
          </Text>
